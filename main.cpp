...
int main(int argc, char *argv[]) {
	try {
		...
		Book *book1 = new Book("GA403", "Big C++", 2009, 8, 3); // ("GA403", "Big C++", 2009, 8, 3)
		Book *book2 = new Book("QA203", "Calcul a plusieurs variables partie 1", 2011, 3, 2);
		Book *book3 = new Book("QA204", "Calcul a plusieurs variables partie 2", 2011, 3, 2);
		Book *book4 = new Book("AC409", "Le chateau d'Ortrante", 1764, 16, 1);
		Book *book5 = new Book("BD302", "Harry Potter et le prisionier d'Azkaban", 1999, 3, 1);
		...
		//unsigned short book_sort_option = {3};
		//library.sortBook(book_sort_option);
		library.print();
		...
		if (library.returnBook("1839456", "QA203")) {
			...
			std::cout << "!!!Returning of QA203 by 1839456 Failed because the Subscriber never borrowed that book!!!\n";
		}
